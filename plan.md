...
<h1>Searchable Handwritten Notes for Obsidian using tldraw and Digital Ink Recognition</h1>
...
Many users prefer sketching ideas, drawing systems diagrams, or writing with a stylus on an infinite canvas.
...
allow freeform drawing inside Obsidian. However, handwritten content inside these canvases is not searchable.
...
This creates a gap in knowledge management systems.

A user may draw an important diagram or write a concept by hand, but later cannot find it through search.
```
...
<h2>Why We Chose This Architecture </h2>
```
...
Users interact naturally with the canvas.

They do not need to trigger OCR manually.
...
When a stroke is created:

stroke vectors extracted
3. Stroke grouping
...
canvas zooms to bounding box of word
Tech Stack
Host Environment
